...
const menuData: Dish[] = [
  ...
  { id: 9,  name: "Truffle Royale", price: { small: 22, large: 30 }, image: "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=200&h=200&fit=crop",  description: "Truffle oil, mushrooms, parmesan, fresh rocket" },
  { id: 10, name: "Smoky Inferno",  price: { small: 19, large: 27 }, image: "https://images.unsplash.com/photo-1628840042765-356cda07504e?w=200&h=200&fit=crop",  description: "Chipotle base, jalapeños, smoked beef, mozzarella" },
  { id: 11, name: "Garden Fiesta",  price: { small: 16, large: 22 }, image: "https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=200&h=200&fit=crop",  description: "Pesto base, zucchini, sundried tomato, feta" },
  { id: 12, name: "Buffalo Ranch",  price: { small: 20, large: 28 }, image: "https://images.unsplash.com/photo-1513104890138-7c749659a591?w=200&h=200&fit=crop",  description: "Ranch base, buffalo chicken, red onion, celery" },
  { id: 13, name: "Pesto Bliss",    price: { small: 17, large: 24 }, image: "https://images.unsplash.com/photo-1571407970349-bc81e7e96d47?w=200&h=200&fit=crop",  description: "Basil pesto, cherry tomatoes, bocconcini, pine nuts" },
  { id: 14, name: "Double Crunch",  price: { small: 21, large: 29 }, image: "https://images.unsplash.com/photo-1593560708920-61dd98c46a4e?w=200&h=200&fit=crop",  description: "Stuffed crust, double cheese, pepperoni, oregano" },
];
                    ...
                    <button key={dish.id} className="pizza-card" onClick={addToCart}>
                      <div className="pizza-img-wrap">
                        <Image
                          ...
                          fill
                          sizes="80px"
                          unoptimized={dish.image.startsWith("https")}
                        />
                      </div>
